            ...
            Select Case NomReport
                ...
                Case "DifPeso"
                    If TCVE_TRACTOR.Text.Trim.Length > 0 Then
                        StiReport1.Item("TRACTOR1") = TCVE_TRACTOR.Text
                        StiReport1.Item("TRACTOR2") = TCVE_TRACTOR.Text
                        StiReport1("UNIDAD") = "Unidad: " & TCVE_TRACTOR.Text
                    Else
                        StiReport1.Item("TRACTOR1") = ""
                        StiReport1.Item("TRACTOR2") = "XXXXXXX"
                        StiReport1("UNIDAD") = ""
                    End If
                    If TCVE_TANQUE1.Text.Trim.Length > 0 Then
                        StiReport1.Item("CVE_TANQUE1") = TCVE_TANQUE1.Text
                        StiReport1.Item("CVE_TANQUE2") = TCVE_TANQUE1.Text
                        StiReport1("TANQUE1") = "Tanque: " & TCVE_TANQUE1.Text
                    Else
                        StiReport1.Item("CVE_TANQUE1") = ""
                        StiReport1.Item("CVE_TANQUE2") = "XXXXXXX"
                        StiReport1("TANQUE1") = ""
                    End If

                    If TCVE_OPER.Text.Trim.Length > 0 Then
                        StiReport1.Item("CVE_OPER1") = TCVE_OPER.Text
                        StiReport1.Item("CVE_OPER2") = TCVE_OPER.Text
                        StiReport1("OPER") = "Operador: (" & TCVE_OPER.Text & ") " & LOper.Text
                    Else
                        StiReport1.Item("CVE_OPER1") = 0
                        StiReport1.Item("CVE_OPER2") = 9999
                        StiReport1("OPER") = ""
                    End If
                    If TCVE_ART.Text.Trim.Length > 0 Then
                        StiReport1.Item("CVE_ART1") = TCVE_ART.Text
                        StiReport1.Item("CVE_ART2") = TCVE_ART.Text
                        StiReport1("MAT") = "Producto: (" & TCVE_ART.Text & ") " & LtDescr.Text
                    Else
                        StiReport1.Item("CVE_ART1") = 0
                        StiReport1.Item("CVE_ART2") = 9999
                        StiReport1("MAT") = ""
                    End If
