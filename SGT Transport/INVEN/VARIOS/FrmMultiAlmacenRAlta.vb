...
Public Class FrmMultiAlmacenRAlta
    Private Sub frmMultiAlmacenRAlta_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        End If
    End Sub
    Private Sub frmMultiAlmacenRAlta_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub
    Private Sub frmMultiAlmacenRAlta_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        End Select
    End Sub
    Private Sub frmMultiAlmacenRAlta_KeyPress(sender As Object, e As KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub barGrabar_Click(sender As Object, e As EventArgs) Handles barGrabar.Click
        ...
        Try
            Dim DESCR As String
            DESCR = BUSCA_CAT("InvenR", tCVE_ART.Text)
            If DESCR <> "N" Then
            Else
        ...
        SQL = "UPDATE GCMULTR" & Empresa & " SET CTRL_ALM = @CTRL_ALM, STOCK_MIN = @STOCK_MIN,
            STOCK_MAX = @STOCK_MAX, COMP_X_REC = @COMP_X_REC
            WHERE CVE_ART = @CVE_ART AND CVE_ALM = @CVE_ALM
            IF @@ROWCOUNT = 0
            INSERT INTO GCMULTR" & Empresa & " (CVE_ART, CVE_ALM, STATUS, CTRL_ALM, EXIST, STOCK_MIN, STOCK_MAX, COMP_X_REC, UUID, VERSION_SINC)
