...
Public Class FrmConfiguracionCFDI
    ...
    Private Sub BarGrabar_Click(sender As Object, e As ClickEventArgs) Handles BarGrabar.Click
        ...
        SQL = "IF EXISTS (SELECT USUARIO FROM CFDI_CFG)
            ...
            MUNICIPIO_NOSAT = @MUNICIPIO_NOSAT, REFERENCIA = @REFERENCIA, ADDENDA_CE = @ADDENDA_CE
            ELSE
            ...
            RUTA_XML_NOTIMBRADO_CONPRECIOS, FTOFACTURA, FTODEV, FTOCOMPPAGO, COLONIA_NOSAT, LOCALIDAD_NOSAT, MUNICIPIO_NOSAT, REFERENCIA, ADDENDA_CE)
            VALUES 
