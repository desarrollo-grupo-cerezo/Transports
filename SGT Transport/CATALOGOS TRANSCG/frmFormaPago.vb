...
Public Class frmFormaPago
    ...
    Private Sub frmFormaPago_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed

        CloseTab("Formas de Pago")
        Me.Dispose()
    End Sub
    ...
    Sub DESPLEGAR()
        ...
        Try
            ...
            SQL = "SELECT CVE_PAGO, DESCR, STATUS FROM GCFORMAPAGO"
    ...
    Private Sub barEliminar_Click(sender As Object, e As EventArgs) Handles barEliminar.Click
        ...
        Try
            If MsgBox("Realmente desea eliminar el registro?", vbYesNo) = vbYes Then
                SQL = "UPDATE GCFORMAPAGO SET STATUS = 'B' WHERE CVE_PAGO = '" & Fg(Fg.Row, 1) & "'"
                Dim cmd As New SqlCommand
                cmd.Connection = cnSAE
                cmd.CommandText = SQL
