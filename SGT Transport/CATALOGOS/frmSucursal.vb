...
Public Class frmSucursal
    ...
    Private Sub frmSucursal_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        CloseTab("Sucursales")
        Me.Dispose()
    End Sub

    Private Sub frmSucursal_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Sub DESPLEGAR()
        ...
        Try
            ...
            SQL = "SELECT CVE_SUC, STATUS, DESCR FROM GCSUCURSAL"
            ...
            Do While dr.read
                fg.additem("" & vbtab & dr("CVE_SUC") & vbtab & dr("STATUS") & vbtab & dr("DESCR"))
            Loop
            dr.close()
            Fg.AutoSizeCols()
    ...
    Private Sub barEliminar_Click(sender As Object, e As EventArgs) Handles barEliminar.Click
        Try
            If MsgBox("Realmente desea eliminar el registro?", vbYesNo) = vbYes Then
                SQL = "UPDATE GCSUCURSAL SET STATUS = 'B' WHERE CVE_SUC = '" & Fg(Fg.Row, 1) & "'"
                Dim cmd As New SqlCommand
                cmd.Connection = cnSAE
                cmd.CommandText = SQL
