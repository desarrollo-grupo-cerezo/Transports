...
Public Class FrmMultiAlmacenR
    Private BindingSource1 As Windows.Forms.BindingSource = New BindingSource
    Dim CADENA As String

    Private Sub frmMultiAlmacenR_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub barNuevo_Click(sender As Object, e As EventArgs) Handles barNuevo.Click
        Try
            Var1 = "Nuevo"
            frmMultiAlmacenRAlta.ShowDialog()
            DESPLEGAR()
        Catch ex As Exception
    ...
    Private Sub barEliminar_Click(sender As Object, e As EventArgs) Handles barEliminar.Click
        Try
            If MsgBox("Realmente desea eliminar el registro?", vbYesNo) = vbYes Then
                SQL = "UPDATE GCMULTR" & Empresa & " SET STATUS = 'B' " &
    ...
    Private Sub mnuSalir_Click(sender As Object, e As EventArgs) Handles mnuSalir.Click
        Me.Close()
    End Sub
    Private Sub frmMultiAlmacenR_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
