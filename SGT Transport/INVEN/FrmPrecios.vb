...
Public Class FrmPrecios
    ...
    Sub DESPLEGAR()
        ...
        Try
            ...
            SQL = "SELECT CVE_PRECIO, DESCRIPCION, STATUS FROM GCPRECIOSAF WHERE STATUS = 'A'"
    ...
    Private Sub frmPrecios_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        CloseTab("Precios inventario fijo")
        Me.Dispose()
    End Sub
    ...
    Private Sub barEliminar_Click(sender As Object, e As EventArgs) Handles barEliminar.Click
        Try
            If MsgBox("Realmente desea eliminar el registro?", vbYesNo) = vbYes Then
                SQL = "UPDATE GCPRECIOSAF SET STATUS = 'B' WHERE CVE_PRECIO = " & Fg(Fg.Row, 1)
                Dim cmd As New SqlCommand
                cmd.Connection = cnSAE
                cmd.CommandText = SQL
