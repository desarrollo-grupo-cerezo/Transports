...
Public Class FrmReportInspecLlantas
    Private Sub FrmReportInspecLlantas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub FrmReportInspecLlantas_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub
