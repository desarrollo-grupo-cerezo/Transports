...
Public Class FrmPagoMultidocCxC
    ...
    Private Sub BarGrabar_Click(sender As Object, e As EventArgs) Handles BarGrabar.Click
        ...
        Try
            ...
            For j = 1 To Fg.Rows.Count - 1
                ...
                If REFER.Trim.Length > 0 And IMPORTE > 0 Then
                    ...
                    CUEN_DET_COM(REFER, IMPORTE, NUM_CPTO, DOCTO, NUM_CARGO)
        ...
        End Try
    End Sub
    Sub CUEN_DET_COM(fCVE_DOC As String, fIMPORTE As Decimal, fNUM_CPTO As Integer, fDOCTO As String, FNUM_CARGO As Integer)
        ...
        Try
            ...
            SQL = "INSERT INTO CUEN_DET" & Empresa & " (CVE_CLIE, REFER, ID_MOV, NUM_CPTO, NUM_CARGO, CVE_OBS, NO_FACTURA, DOCTO, 
                ...
                ISNULL((SELECT MAX(NO_PARTIDA) + 1 FROM CUEN_DET" & Empresa & " WHERE REFER = '" & REFER & "' AND CVE_CLIE = '" & CVE_CLIE & "'),1))"
