...
Public Class FrmLiqIngresosXOperador
    Private Sub FrmLiqIngresosXOperador_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Dim i As Integer = 1
            F1.Value = Date.Today
        ...
        End Try
    End Sub
    Private Sub FrmLiqIngresosXOperador_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub
    Private Sub BarImprimir_Click(sender As Object, e As C1.Win.C1Command.ClickEventArgs) Handles BarImprimir.Click
        Try
            ...
            RUTA_FORMATOS = GET_RUTA_FORMATOS() & "\ReportLiqIngresosXOperador.mrt"
    ...
    Private Sub BarDisenador_Click(sender As Object, e As C1.Win.C1Command.ClickEventArgs) Handles BarDisenador.Click
        PrinterMRT("ReportLiqIngresosXOperador")
    End Sub
