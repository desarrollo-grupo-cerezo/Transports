...
Public Class frmDestino
    ...
    Sub DESPLEGAR()
        ...
        Try
            ...
            SQL = "SELECT CLAVE, DESCR, STATUS FROM GCDESTINO WHERE STATUS = 'A'"
            ...
            Do While dr.Read
                Fg.AddItem("" & vbTab & dr("CLAVE") & vbTab & dr("DESCR") & vbTab & dr("STATUS"))
            Loop
            dr.Close()
            Fg.AutoSizeCols()
    ...
    Private Sub frmDestino_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        CloseTab("Destino")
        Me.Dispose()
    End Sub

    Private Sub frmDestino_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub barEliminar_Click(sender As Object, e As EventArgs) Handles barEliminar.Click
        Try
            If MsgBox("Realmente desea eliminar el registro?", vbYesNo) = vbYes Then
                SQL = "UPDATE GCDESTINO SET STATUS = 'B' WHERE  = '" & Fg(Fg.Row, 1) & "'"
                Dim cmd As New SqlCommand
                cmd.Connection = cnSAE
                cmd.CommandText = SQL
