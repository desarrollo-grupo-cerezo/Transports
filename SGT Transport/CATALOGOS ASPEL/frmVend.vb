...
Public Class frmVend
    ...
    Private Sub frmVend_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        CloseTab("Vendedores")
        Me.Dispose()
    End Sub

    Private Sub frmVend_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Sub DESPLEGAR()
        ...
        Try
            ...
            SQL = "SELECT CVE_VEND, STATUS, NOMBRE, COMI, CLASIFIC, CORREOE FROM VEND" & Empresa & " ORDER BY CVE_VEND"
            ...
            Do While dr.read
                Fg.AddItem("" & vbTab & dr("CVE_VEND") & vbTab & dr("STATUS") & vbTab & dr("NOMBRE") & vbTab & dr("COMI") & vbTab &
                           dr("CLASIFIC") & vbTab & dr("CORREOE"))
            Loop
            dr.close()
            Fg.AutoSizeCols()
    ...
    Private Sub barEliminar_Click(sender As Object, e As EventArgs) Handles barEliminar.Click
        Try
            If MsgBox("Realmente desea eliminar el registro?", vbYesNo) = vbYes Then
                SQL = "UPDATE VEND" & Empresa & " SET STATUS = 'B' WHERE CVE_VEND = '" & Fg(Fg.Row, 1) & "'"
                Dim cmd As New SqlCommand
                cmd.Connection = cnSAE
                cmd.CommandText = SQL
