...
Public Class frmValeCombustible
    ...
    Sub DESPLEGAR()
        ...
        Try
            ...
            SQL = "SELECT CVE_FOLIO, STATUS, FECHA, FECHA_VALE, FECHA_CARGA, VALE_GAS, CVE_UNI, CVE_GAS, CVE_CAR, PRECIO, IMPORTE, LITROS, " &
                "LITROS_REAL, CVE_OBS " &
                "FROM GCVALE_COMBUSTIBLE WHERE STATUS = 'A' AND TIPO = 'VC'"
            cmd.CommandText = SQL
    ...
    Private Sub barNuevo_Click(sender As Object, e As EventArgs) Handles barNuevo.Click
        Try
            ...
            frmValeCombustibleAE.ShowDialog()
