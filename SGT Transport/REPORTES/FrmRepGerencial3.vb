...
Public Class FrmRepGerencial3
    Private Sub FrmRepGerencial3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub BarImprimir_Click(sender As Object, e As ClickEventArgs) Handles BarImprimir.Click
        Try
            ...
            RUTA_FORMATOS = GET_RUTA_FORMATOS() & "\ReporGerencial3.mrt"
    ...
    Private Sub FrmRepGerencial3_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Close()
    End Sub

    Private Sub BarDisenador_Click(sender As Object, e As ClickEventArgs) Handles BarDisenador.Click
        PrinterMRT("ReporGerencial3")
    End Sub
End Class