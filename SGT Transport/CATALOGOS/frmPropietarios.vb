...
Public Class frmPropietarios
    ...
    Sub DESPLEGAR()
        ...
        Try
            ...
            SQL = "SELECT CVE_PROP, STATUS, NOMBRE FROM GCPROPIETARIOS"
            ...
            Do While dr.Read
                Fg.AddItem("" & vbTab & dr("CVE_PROP") & vbTab & dr("STATUS") & vbTab & dr("NOMBRE"))
            Loop
            dr.Close()
            Fg.AutoSizeCols()
    ...
    Private Sub barEliminar_Click(sender As Object, e As EventArgs) Handles barEliminar.Click
        Try
            If MsgBox("Realmente desea eliminar el registro?", vbYesNo) = vbYes Then
                SQL = "UPDATE GCPROPIETARIOS SET STATUS = 'B' WHERE CVE_PROP = '" & Fg(Fg.Row, 1) & "'"
                Dim cmd As New SqlCommand
                cmd.Connection = cnSAE
                cmd.CommandText = SQL
