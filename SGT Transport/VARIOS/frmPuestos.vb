...
Public Class frmPuestos
    ...
    Private Sub frmPuestos_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed

        CloseTab("Puestos")
        Me.Dispose()
    End Sub

    Private Sub frmPuestos_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Sub DESPLEGAR()
        ...
        Try
            ...
            SQL = "SELECT CVE_PUESTO, DESCR, STATUS FROM GCPUESTOS"
            ...
            Do While dr.Read
                Fg.AddItem("" & vbTab & dr("CVE_PUESTO") & vbTab & dr("DESCR") & vbTab & dr("STATUS"))
            Loop
            dr.Close()
            Fg.AutoSizeCols()
    ...
    Private Sub barEliminar_Click(sender As Object, e As EventArgs) Handles barEliminar.Click
        ...
        Try
            If MsgBox("Realmente desea eliminar el registro?", vbYesNo) = vbYes Then
                SQL = "UPDATE GCPUESTOS SET STATUS = 'B' WHERE CVE_PUESTO = '" & Fg(Fg.Row, 1) & "'"
                Dim cmd As New SqlCommand
                cmd.Connection = cnSAE
                cmd.CommandText = SQL
