...
Public Class FrmAlmacenesRAE
    Private Sub frmAlmacenesRAE_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Else
            Try
                ...
                SQL = "SELECT M.CVE_ALM, M.DESCR, CUEN_CONT FROM GCALMACENESR" & Empresa & " M WHERE CVE_ALM = " & Var2
                cmd.CommandText = SQL
    ...
    Private Sub frmAlmacenesRAE_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmAlmacenesRAE_KeyPress(sender As Object, e As KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub barGrabar_Click(sender As Object, e As EventArgs) Handles barGrabar.Click
        ...
        cmd.CommandText = "UPDATE GCALMACENESR" & Empresa & " SET DESCR = @DESCR, CUEN_CONT = @CUEN_CONT 
            WHERE CVE_ALM = @CVE_ALM 
            IF @@ROWCOUNT = 0 
            INSERT INTO GCALMACENESR" & Empresa & " (CVE_ALM, DESCR, STATUS, CUEN_CONT, UUID, VERSION_SINC) VALUES(@CVE_ALM, @DESCR, 'A', 
    ...
    Private Sub frmAlmacenesRAE_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub
End Class
