...
Public Class FrmCxP
    ...
    Sub DESPLEGAR()
        ...
        Try
            ...
            SQL = "SELECT NUM_CPTO, DESCR, TIPO, CUEN_CONT, CON_REFER, GEN_CPTO, AUTORIZACION, ES_FMA_PAG, STATUS " &
                "FROM CONP" & Empresa & " WHERE STATUS = 'A'"
            ...
            Do While dr.Read
                Fg.AddItem("" & vbTab & dr("NUM_CPTO") & vbTab & dr("DESCR") & vbTab & IIf(dr("TIPO") = "C", "Cargo", "Abono") & vbTab & dr("CUEN_CONT") & vbTab &
                           dr("CON_REFER") & vbTab & dr("GEN_CPTO") & vbTab & dr("AUTORIZACION") & vbTab & dr("ES_FMA_PAG") & vbTab & dr("STATUS"))
            Loop
            dr.Close()
            Fg.AutoSizeCols()
    ...
    Private Sub frmCxP_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        CloseTab("Conceptos CxP")
        Me.Dispose()
    End Sub
    Private Sub frmCxP_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub barEliminar_Click(sender As Object, e As EventArgs) Handles barEliminar.Click
        Try
            If MsgBox("Realmente desea eliminar el registro?", vbYesNo) = vbYes Then
                SQL = "UPDATE CONP" & Empresa & " SET STATUS = 'B' WHERE NUM_CPTO = " & Fg(Fg.Row, 1)
                Dim cmd As New SqlCommand
                cmd.Connection = cnSAE
                cmd.CommandText = SQL
