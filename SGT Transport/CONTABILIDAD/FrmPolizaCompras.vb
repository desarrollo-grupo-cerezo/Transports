...
Public Class FrmPolizaCompras
    ...
    Private Sub FrmPolizaCompras_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Sub GET_RUTA_MODELO()
        ...
        End Try
    End Sub
    Private Sub FrmPolizaCompras_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
        CloseTab("Póliza compras")
    End Sub
    Sub DESPLEGAR()
    ...
    Sub DESPLEGAR_ALMACEN()
        ...
        Try
            SQL = "SELECT  P.NUM_ALM, MAX(A.DESCR), ROUND(SUM(P.TOT_PARTIDA),6) AS IMPORT, MAX(A.CUEN_CONT) AS 'Cuenta contable'
                ...
                LEFT JOIN COMPC" & Empresa & " C ON C.CVE_DOC = P.CVE_DOC
    ...
    Private Sub BarGenPoliza_Click(sender As Object, e As ClickEventArgs) Handles BarGenPoliza.Click
        ...
        Dim POLIZA_MODELO As String, TOTAL As Decimal = 0, CONCEPTO As String, FILE_XML As String = "", NUM_PAR As Long = 12903, NUM_PARX As Long
        ...
        Try
            ...
            For k = 1 To Fg.Rows.Count - 1
                ...
                If CVE_DOC.Trim.Length > 0 And IMPORTE > 0 Then
                    ...
                    s = s & " Monto=""" & Math.Round(IMPORTE, 2) & """ TipoCambio=""1"" DebeHaber=""H"" ccostos=""0"" proyectos=""0"" FRMPAGO="""" NUMCHEQUE="""" MONTOBN=""0"" BANCO=""0"" CTAORIG="""" BENEF="""""
            ...
            If IMP2 > 0 Then
                ...
                s = s & "Impuesto " & """ Monto=""" & Math.Round(IMP2, 2) & """ TipoCambio=""1"" DebeHaber=""D"" ccostos=""0"" proyectos=""0"" FRMPAGO="""" NUMCHEQUE="""" MONTOBN=""0"" BANCO=""0"" CTAORIG="""" BENEF="""" RFC="""" BANCODEST=""0"" CTADEST="""" FECHACHEQUE="""" BANCOORIGEXT="""" BANCODESTEXT="""" IDUUID=""" & NUM_PARX & """ IDFISCAL=""""><CDSPartidasUUID></CDSPartidasUUID></ROWPartidas>"
            End If

            If IMP3 > 0 Then
                s = s & "<ROWPartidas Cuenta=""" & CTA_RETENCION_IVA & """ Depto=""0"" ConceptoPol="""
                s = s & "Impuesto " & """ Monto=""" & Math.Round(IMP3, 2) & """ TipoCambio=""1"" DebeHaber=""D"" ccostos=""0"" proyectos=""0"" FRMPAGO="""" NUMCHEQUE="""" MONTOBN=""0"" BANCO=""0"" CTAORIG="""" BENEF="""" RFC="""" BANCODEST=""0"" CTADEST="""" FECHACHEQUE="""" BANCOORIGEXT="""" BANCODESTEXT="""" IDUUID=""" & NUM_PARX & """ IDFISCAL=""""><CDSPartidasUUID></CDSPartidasUUID></ROWPartidas>"
            End If

            If IMP4 > 0 Then
                s = s & "<ROWPartidas Cuenta=""" & CTA_IVA & """ Depto=""0"" ConceptoPol="""
                s = s & "Impuesto " & """ Monto=""" & Math.Round(IMP4, 2) & """ TipoCambio=""1"" DebeHaber=""D"" ccostos=""0"" proyectos=""0"" FRMPAGO="""" NUMCHEQUE="""" MONTOBN=""0"" BANCO=""0"" CTAORIG="""" BENEF="""" RFC="""" BANCODEST=""0"" CTADEST="""" FECHACHEQUE="""" BANCOORIGEXT="""" BANCODESTEXT="""" IDUUID=""" & NUM_PARX & """ IDFISCAL=""""><CDSPartidasUUID></CDSPartidasUUID></ROWPartidas>"
            End If
        ...
        MsgBox("La poliza modelo se grabo satisfactoriamente en " & POLIZA_MODELO)
        ...
        Try
            ...
            If XML.Trim.Length > 0 Then
                ...
                If xNodo.Count > 0 Then
                    ...
                    Catch ex As Exception
                    End Try
                    'IMPUESTOS TRASLADADOS     IMPUESTOS TRASLADADOS       IMPUESTOS TRASLADADOS
                    Try
