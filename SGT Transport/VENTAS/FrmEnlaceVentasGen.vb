...
Public Class FrmEnlaceVentasGen
    Dim _myEditor As MyEditorEV
    Dim ENTRA As Boolean
    Private TDOC As String

    Private Sub frmEnlaceVentasGen_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Select Case Var15
                Case "R"
                    Lt1.Text = "Remisiones"
                Case "V"
                    Lt1.Text = "Nota de venta"
                Case "P"
                    Lt1.Text = "Pedidos"
                Case "C"
                    Lt1.Text = "Cotizaciones"
            End Select
            ENTRA = True
            Fg.Rows.Count = 2
            Fg.Rows(0).Height = 30
            ...
            Fg.Cols(2).Width = 18
            Var11 = ""
            _myEditor = New MyEditorEV(Fg, 10)
        ...
        End Try
    End Sub
    Private Sub frmEnlaceVentasGen_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub
    ...
    Private Sub tCLAVE_Validated(sender As Object, e As EventArgs) Handles tCLAVE.Validated
        Try
            If tCLAVE.Text.Trim.Length > 0 Then
                ...
                DESCR = BUSCA_CAT("Cliente", tCLAVE.Text)
                If DESCR <> "" Then
                    Var11 = tCLAVE.Text
                    LtNombre.Text = DESCR
                Else
    ...
    Private Sub Fg_CellButtonClick(sender As Object, e As RowColEventArgs) Handles Fg.CellButtonClick
        Try
            ...
            Var15 = TDOC 'TIPO DOCUMENTO R V C P
    ...
    Private Sub Fg_CellChanged(sender As Object, e As RowColEventArgs) Handles Fg.CellChanged
    ...
    Private Sub BarRemision_Click(sender As Object, e As EventArgs) Handles BarRemision.Click
        TDOC = "R"
        Lt1.Text = "Remisiones"
    End Sub

    Private Sub BarCotizacion_Click(sender As Object, e As EventArgs) Handles BarCotizacion.Click
        TDOC = "C"
        Lt1.Text = "Cotizaciones"
    End Sub
    ...
    Private Sub BarEliminar_Click_1(sender As Object, e As EventArgs) Handles BarEliminar.Click
        Try
            If Fg.Row > 0 Then
...
Public Class MyEditorEV
        ...
        Try
            If _col = 1 And MyBase.Text.Trim.Length > 0 Then 'DOCUMENTO
                Try
                    ...
                    Descr = BUSCA_CAT("FACT", MyBase.Text)
    ...
    Protected Sub MoveCursor(ByVal key As Keys)
        ...
        If col = 1 And key = Keys.Left Then
            frmEnlaceVentasGen.tMagico2.Focus()
            Return
        End If
                    ...
                    Select Case col
                        Case 1
                            ...
                            If HayErr Then
                                ...
                                _owner.Select(row + 1, 1)
                            Else
                                If Not IsNothing(_owner(row, 2)) And Not IsNothing(_owner(row, 4)) Then
                                    If _owner(row, 2).ToString.Length > 0 And _owner(row, 4).ToString.Length > 0 Then
                                    End If
                                End If
