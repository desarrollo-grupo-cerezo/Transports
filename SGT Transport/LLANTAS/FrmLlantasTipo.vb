...
Public Class FrmLlantasTipo

    Private Sub frmLlantasTipo_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed

        CloseTab("Tipo Llanta")
        Me.Dispose()
    End Sub

    Private Sub frmLlantasTipo_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmLlantasTipo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        '20 FEB 20
    ...
    Sub DESPLEGAR()
        ...
        Try
            ...
            SQL = "SELECT CVE_TIPO, STATUS, DESCR FROM GCLLANTA_TIPO"
    ...
    Private Sub barEliminar_Click(sender As Object, e As EventArgs) Handles barEliminar.Click
        Try
            If MsgBox("Realmente desea eliminar el registro?", vbYesNo) = vbYes Then
                ...
                SQL = "UPDATE GCLLANTA_TIPO SET STATUS = 'B' WHERE CVE_TIPO = '" & Fg(Fg.Row, 1) & "'"
                Dim cmd As New SqlCommand
                cmd.Connection = cnSAE
                cmd.CommandText = SQL
