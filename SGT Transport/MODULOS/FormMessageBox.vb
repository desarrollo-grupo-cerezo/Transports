...
Public Class FormMessageBox
    'Fields
    Private _primaryColor As Color = Color.FromArgb(16, 110, 190) '.CornflowerBlue
    ...
    Public Property PrimaryColor As Color
        ...
        Set(value As Color)
            ...
            Me.panelBody.BackColor = Color.FromArgb(191, 219, 255) 'Color.FromArgb(207, 214, 229)
            Me.labelMessage.BackColor = Color.FromArgb(191, 219, 255) 'Color.FromArgb(207, 214, 229)
            Me.panelButtons.BackColor = Color.FromArgb(191, 219, 255) 'Color.FromArgb(207, 214, 229)
        End Set
    End Property
    ...
    Private Sub FormMessageBox_Load(sender As Object, e As EventArgs) Handles MyBase.Load


    End Sub

    Private Sub FormMessageBox_Paint(sender As Object, e As PaintEventArgs) Handles Me.Paint
