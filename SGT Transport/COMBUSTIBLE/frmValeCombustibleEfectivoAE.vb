...
Public Class frmValeCombustibleEfectivoAE
    ...
    Private Sub frmValeCombustibleAE_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        BtnCarPorte.FlatStyle = FlatStyle.Flat
        BtnCarPorte.FlatAppearance.BorderSize = 0
        ...
        If Var1 = "Nuevo" Then
            Try
                tCVE_FOLIO.Text = GET_MAX("GCVALE_COMBUSTIBLE", "CVE_FOLIO", 0, " WHERE TIPO = 'FC'")
        ...
        Else
            Try
                ...
                SQL = "SELECT V.CVE_FOLIO, V.FECHA_VALE, V.FECHA_CARGA, V.VALE_GAS, V.CVE_UNI, V.CVE_GAS, V.CVE_CAR, V.PRECIO, V.IMPORTE, " &
                    ...
                    "WHERE CVE_FOLIO = '" & Var2 & "' AND STATUS = 'A' AND TIPO = 'FC'"
    ...
    Private Sub barGrabar_Click(sender As Object, e As EventArgs) Handles barGrabar.Click
        ...
        SQL = "UPDATE GCVALE_COMBUSTIBLE SET FECHA_VALE = @FECHA_VALE, NUM_CPTO = @NUM_CPTO, " &
            ...
            "WHERE CVE_FOLIO = @CVE_FOLIO AND TIPO = 'FC' " &
            "IF @@ROWCOUNT = 0 " &
        ...
        Try
            ...
            cmd.Parameters.Add("@TIPO", SqlDbType.VarChar).Value = "FC"
