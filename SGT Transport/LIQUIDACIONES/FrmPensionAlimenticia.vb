...
Public Class FrmPensionAlimenticia
    Private Sub FrmPensionAlimenticia_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Dim i As Integer = 1
            F1.Value = Date.Today
    ...
    Private Sub BarDisenador_Click(sender As Object, e As ClickEventArgs) Handles BarDisenador.Click
        PrinterMRT("ReportPensionAlimenticia")
    End Sub
    ...
    Private Sub BarImprimir_Click(sender As Object, e As ClickEventArgs) Handles BarImprimir.Click
        Try
            ...
            RUTA_FORMATOS = GET_RUTA_FORMATOS() & "\ReportPensionAlimenticia.mrt"
