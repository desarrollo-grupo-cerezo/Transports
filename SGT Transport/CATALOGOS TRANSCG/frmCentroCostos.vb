...
Public Class frmCentroCostos
    ...
    Sub DESPLEGAR()
        ...
        Try
            ...
            SQL = "SELECT CVE_COSTOS, DESCR, STATUS FROM GCCENTRO_COSTOS WHERE STATUS = 'A'"
            ...
            Do While dr.Read
                Fg.AddItem("" & vbTab & dr("CVE_COSTOS") & vbTab & dr("DESCR") & vbTab & dr("STATUS"))
            Loop
            dr.Close()
            Fg.AutoSizeCols()
    ...
    Private Sub frmCentroCostos_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        CloseTab("Centro de Costos")
        Me.Dispose()
    End Sub

    Private Sub frmCentroCostos_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub barEliminar_Click(sender As Object, e As EventArgs) Handles barEliminar.Click
        Try
            If MsgBox("Realmente desea eliminar el registro?", vbYesNo) = vbYes Then
                SQL = "UPDATE GCCENTRO_COSTOS SET STATUS = 'B' WHERE CVE_COSTOS = " & Fg(Fg.Row, 1)
                Dim cmd As New SqlCommand
                cmd.Connection = cnSAE
                cmd.CommandText = SQL
