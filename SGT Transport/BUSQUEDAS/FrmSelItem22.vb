        ...
        Try
            ...
            Select Case Proceso
                ...
                Case "USOCFDI"
                    ...
                    Me.MinimizeBox = False
                Case "tblcformapago"
                    SQL = "SELECT formaPago, descripcion FROM tblcformapago ORDER BY descripcion"
                    Fg.Cols.Count = 3
                ...
                Using dr As SqlDataReader = cmd.ExecuteReader
                    While dr.Read
                        Select Case Proceso
                            ...
                            Case "USOCFDI", "MONEDA", "tblcformapago"
            ...
            Select Case Proceso
                Case "tblcformapago"
                    SQL = "SELECT formaPago, descripcion FROM tblcformapago
                        WHERE formaPago LIKE '%" & TBox.Text & "%' OR descripcion LIKE '%" & TBox.Text & "%'
                        ORDER BY formaPago"
                Case "ClasificProv"
