...
Public Class FrmEnlaceVentas
    Dim _myEditor As MyEditor2
    Dim ENTRA As Boolean
    Private TDOC As String

    Private Sub frmEnlaceVentas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        End Try
    End Sub
    Private Sub frmEnlaceVentas_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub
