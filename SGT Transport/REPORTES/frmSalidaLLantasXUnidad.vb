...
Public Class frmSalidaLLantasXUnidad
    Private Sub frmSalidaLLantasXUnidad_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
        ...
        End Try
    End Sub
    Private Sub frmSalidaLLantasXUnidad_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub
    ...
    Private Sub BarImprimir_Click(sender As Object, e As ClickEventArgs) Handles BarImprimir.Click
        Try
            ...
            RUTA_FORMATOS = GET_RUTA_FORMATOS() & "\ReportSalidasLlantasXUnidad.mrt"
