...
Public Class frmStatusLlantas

    Private Sub frmStatusLlantas_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed

        CloseTab("Status Llantas")
        Me.Dispose()
    End Sub

    Private Sub frmStatusLlantas_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmStatusLlantas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        '20 FEB 20
    ...
    Sub DESPLEGAR()
        ...
        Try
            ...
            SQL = "SELECT CVE_STATUS, DESCR FROM GCLLANTA_STATUS"
            ...
            Do While dr.Read
                Fg.AddItem("" & vbTab & dr("CVE_STATUS") & vbTab & dr("DESCR"))
            Loop
            dr.Close()
            Fg.AutoSizeCols()
    ...
    Private Sub barEliminar_Click(sender As Object, e As EventArgs) Handles barEliminar.Click
        ...
        Try
            If MsgBox("Realmente desea eliminar el registro?", vbYesNo) = vbYes Then
                SQL = "UPDATE GCLLANTA_STATUS SET STATUS = 'B' WHERE CVE_STATUS = '" & Fg(Fg.Row, 1) & "'"
                Dim cmd As New SqlCommand
                cmd.Connection = cnSAE
                cmd.CommandText = SQL
