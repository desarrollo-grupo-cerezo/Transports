...
Public Class FrmMultiAlmacenAlta
    Private Sub frmMultiAlmacenAlta_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Else
            Try
                ...
                SQL = "SELECT M.CVE_ART, ISNULL(M.CVE_ALM,1) AS ALM, M.STATUS, M.CTRL_ALM, M.EXIST, M.STOCK_MIN, M.STOCK_MAX, M.COMP_X_REC " &
                    "FROM MULT" & Empresa & " M WHERE CVE_ART = '" & Var2 & "' AND CVE_ALM = " & Var3
                cmd.CommandText = SQL
                dr = cmd.ExecuteReader
        ...
        End If
    End Sub
    Private Sub frmMultiAlmacenAlta_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub
    Private Sub frmMultiAlmacenAlta_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        End Select
    End Sub
    Private Sub frmMultiAlmacenAlta_KeyPress(sender As Object, e As KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub barGrabar_Click(sender As Object, e As EventArgs) Handles barGrabar.Click
        ...
        SQL = "UPDATE MULT" & Empresa & " SET CTRL_ALM = @CTRL_ALM, STOCK_MIN = @STOCK_MIN, " &
